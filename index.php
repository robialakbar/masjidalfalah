...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-default navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="https://masjidnurfalah.com/" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="https://masjidnurfalah.com/" class="brand-link">
                <img src="dist/img/sesed.jpg" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
                <span class="brand-text font-weight-light"> Masjid Nurfalah</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="https://masjidnurfalah.com/" class="d-block">
                            <?php echo $data_nama; ?>
                        </a>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        ?>
                            <li class="nav-item">
                                <a href="https://masjidnurfalah.com/" class="nav-link">
        ...
        <footer class="main-footer">
            ...
            Copyright &copy;
            <a target="_blank" href="https://masjidnurfalah.com/">
                <strong> Masjid Nurfalah</strong>
            </a>
            All rights reserved.
        </footer>
